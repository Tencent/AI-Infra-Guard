...
- **2026-04-23** · [v4.1.5](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.1.5) — Jailbreak detection for Agent Scan; detects exposed AI agent config files.
