...
- **2026-06-18** · [v4.1.14](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.1.14) — New `aig-agent-redteam` skill for comprehensive AI agent red-teaming; 9 new single-turn jailbreak attack methods added to Prompt Security.
