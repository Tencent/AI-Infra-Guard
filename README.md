...
- **2026-08-17** · [v4.5.2](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.2) — Skill-scan: block charset smuggling & expose compiled .pyc in audit; MCP-scan: prevent RCE via prompt injection; new vector DB fingerprints (Qdrant, Chroma, Weaviate); agent-redteam v5.0 mutation engine refactor
