...
> 📢 **News**:
> * A.I.G V3.6.1 AI Infrastructure Scanning now supports n8n (workflow automation platform) and adds detection for 78 CVEs across 15 AI components including Ollama. [View full changelog](./CHANGELOG.md)
