...
A.I.G使用了基于AI Agent驱动的AI工具技能检测方案，支持MCP Server、Skills源代码安全审计与远程MCP Server URL安全扫描，可检测以下常见的AI工具技能安全风险，并持续更新：
...
A.I.G的AI工具技能扫描能力完全由Agent驱动，检测准确性与时长取决于用户选择的大模型API。
