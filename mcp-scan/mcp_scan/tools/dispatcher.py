...
class ToolDispatcher:
    def __init__(
        ...
        # Last error seen across all attempted transports, so callers can surface
        # *why* the connection failed instead of a bare "Failed to connect".
    ...
    async def _ensure_mcp_manager(self) -> MCPTools | None:
        ...
        for transport in transports:
            ...
            try:
                ...
                logger.debug(f"ToolDispatcher: transport '{transport}' failed: {e}")
                continue
