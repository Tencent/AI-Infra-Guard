...
- **2026-09-24** · [v4.6.3](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.6.3) — API Checker: Unterstützung für Claude-5-Modellsignaturen und zuverlässigere Modellidentifikation (fehlgeschlagene Fingerprint-Stichproben werden automatisch nachgefüllt); Prompt-Eval: ratenlimit-bewusstes Backoff, Circuit Breaker und sicherere Prozessgruppen-Beendigung für stabiles Red-Teaming im großen Maßstab.
- **2026-09-17** · [v4.6.2](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.6.2) — Schwachstellenbibliothek um 155 neue CVE-Regeln über mehr als 40 AI-Komponenten erweitert (LangFlow, n8n, PraisonAI, vLLM, llama-cpp, MLflow und mehr); Skill-Scan-Genauigkeitsverbesserungen (weniger beweislose Fehlalarme, Streaming ohne Hänger); neue Agent-Kontrollverlust-Benchmarks (FORGE-Bench, RogueHandoff-20).
