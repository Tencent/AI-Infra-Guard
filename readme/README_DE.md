...
- **2026-08-17** · [v4.5.2](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.2) — Skill-scan: Charset-Smuggling blockiert & kompilierten Bytecode (.pyc) in Audit aufgenommen; MCP-scan: RCE über Prompt-Injection verhindert; neue Vektor-DB-Fingerprints (Qdrant, Chroma, Weaviate); agent-redteam v5.0 Mutations-Engine-Refactoring
