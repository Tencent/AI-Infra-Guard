...
- **2026-09-24** · [v4.6.3](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.6.3) — API Checker: compatibilidad con firmas de modelos Claude 5 e identificación de modelos más fiable (las muestras de huella fallidas se rellenan automáticamente); Prompt-Eval: backoff con reconocimiento de límites de tasa, disyuntor (circuit breaker) y terminación más segura del grupo de procesos para pruebas de red-teaming estables a gran escala.
