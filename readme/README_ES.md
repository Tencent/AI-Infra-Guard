...
- **2026-07-30** · [v4.5.1](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.1) — PromptSecurity: 4 ataques de jailbreak multi-turno (Many-Shot, PAIR, GOAT, ActorAttack); Agent-Scan: 5 nuevas skills OWASP + detección de exfiltración web (10 skills en total); MCP-Scan: 4 nuevas reglas de seguridad; correcciones de bugs (salto de checkbox, huella duplicada, formato CVSS)
