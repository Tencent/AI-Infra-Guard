...
- **2026-06-18** · [v4.1.14](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.1.14) — Nueva skill `aig-agent-redteam` para evaluación integral de red team de agentes IA; 9 nuevos métodos de ataque jailbreak de turno único añadidos a Prompt Security.
