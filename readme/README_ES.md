...
| **Escaneo de vulnerabilidades en infraestructura de IA** | Este scanner identifica con precisión más de 64 componentes de frameworks de IA. Cubre más de 1300 vulnerabilidades CVE conocidas. Los frameworks soportados incluyen Ollama, ComfyUI, vLLM, n8n, Triton Inference Server y más. |
...
4. Haz clic en **Iniciar Escaneo** — A.I.G identificará el servicio y lo comparará con más de 1300 CVE conocidos
...
<details>
<summary>Estamos profundamente agradecidos a los equipos de investigación que han utilizado A.I.G en su trabajo académico. Haz clic para expandir (18 artículos)</summary>
<br>
