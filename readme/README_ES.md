...
- **2026-08-17** · [v4.5.2](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.2) — Skill-scan: bloqueo de contrabando de charset y exposición de bytecode compilado (.pyc) en auditoría; MCP-scan: prevención de RCE vía inyección de prompt; nuevas huellas para bases de datos vectoriales (Qdrant, Chroma, Weaviate); refactorización del motor de mutación agent-redteam v5.0
