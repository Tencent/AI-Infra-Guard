...
- **2026-07-30** · [v4.5.1](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.1) — PromptSecurity : 4 attaques de jailbreak multi-tours (Many-Shot, PAIR, GOAT, ActorAttack) ; Agent-Scan : 5 nouvelles skills OWASP + détection d'exfiltration web (10 skills au total) ; MCP-Scan : 4 nouvelles règles de sécurité ; corrections de bugs (saut de checkbox, empreinte dupliquée, format CVSS)
