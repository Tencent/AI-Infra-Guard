...
| **AIインフラ脆弱性スキャン** | 58以上のAIフレームワークコンポーネントを正確に識別するスキャナーです。1200以上の既知のCVE脆弱性をカバーしています。対応フレームワークにはOllama、ComfyUI、vLLM、n8n、Triton Inference Serverなどが含まれます。 |
...
4. 「スキャン開始」をクリック — A.I.Gがコンポーネントバージョンを自動識別し、1200以上の既知CVEと照合
