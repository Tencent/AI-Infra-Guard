...
| **AIインフラ脆弱性スキャン** | 64以上のAIフレームワークコンポーネントを正確に識別するスキャナーです。1300以上の既知のCVE脆弱性をカバーしています。対応フレームワークにはOllama、ComfyUI、vLLM、n8n、Triton Inference Serverなどが含まれます。 |
...
4. 「スキャン開始」をクリック — A.I.Gがコンポーネントバージョンを自動識別し、1300以上の既知CVEと照合
...
<details>
<summary>A.I.Gを学術研究に活用し、AIセキュリティ研究の発展に貢献してくださった研究チームの皆様に深く感謝いたします。クリックして展開（18本）</summary>
<br>
