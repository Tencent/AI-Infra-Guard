...
| **AI&nbsp;인프라&nbsp;취약점&nbsp;scan** | 100개 이상의 AI 프레임워크 컴포넌트를 정확하게 식별합니다. 1,700개 이상의 알려진 CVE 취약점을 커버합니다. Ollama, ComfyUI, vLLM, n8n, Triton Inference Server 등의 프레임워크를 지원합니다. |
...
4. **Start Scan**을 클릭합니다 — A.I.G가 서비스의 지문을 채취하여 1,700개 이상의 알려진 CVE와 매칭합니다.
