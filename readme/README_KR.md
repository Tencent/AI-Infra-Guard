...
- **2026-08-17** · [v4.5.2](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.2) — Skill-scan: charset 밀수 공격 차단 및 컴파일된 바이트코드(.pyc) 감사 대상 포함; MCP-scan: Prompt 인젝션 경유 RCE 방지; 벡터 DB 지문 추가 (Qdrant/Chroma/Weaviate); agent-redteam v5.0 변이 엔진 리팩토링
