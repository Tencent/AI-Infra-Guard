...
- **2026-07-30** · [v4.5.1](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.1) — PromptSecurity: 4종 멀티턴 탈옥 공격 추가 (Many-Shot, PAIR, GOAT, ActorAttack); Agent-Scan: 5개 신규 OWASP 스킬 + Web 데이터 유출 탐지 (총 10스킬); MCP-Scan: 4개 신규 보안 규칙; 버그 수정 (체크박스 점프, 중복 핑거프린트, CVSS 형식)
...
4. **Start Scan**을 클릭합니다 — A.I.G가 서비스의 지문을 채취하여 1,900개 이상의 알려진 CVE와 매칭합니다.
