...
- **2026-08-17** · [v4.5.2](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.2) — Skill-scan: bloqueio de contrabando de charset e exposição de bytecode compilado (.pyc) na auditoria; MCP-scan: prevenção de RCE via injeção de prompt; novas impressões digitais de bancos vetoriais (Qdrant, Chroma, Weaviate); refatoração do motor de mutação agent-redteam v5.0
