...
- **2026-05-21** · [v4.1.9](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.1.9) — Prompt Security: 26 novos operadores de ataque (20 de turno único + 6 de múltiplos turnos); agentes de varredura reforçados contra injeção indireta de prompts.
...
- **2026-04-23** · [v4.1.6](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.1.6) — Cobertura expandida para 58 componentes de IA (adicionados FastGPT, Upsonic); atualização em massa do banco de dados de vulnerabilidades para 7 componentes.
