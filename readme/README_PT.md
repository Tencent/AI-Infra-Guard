...
- **2026-09-24** · [v4.6.3](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.6.3) — API Checker: suporte a assinaturas de modelos Claude 5 e identificação de modelos mais confiável (amostras de impressão digital com falha são reabastecidas automaticamente); Prompt-Eval: backoff ciente de limites de taxa, disjuntor (circuit breaker) e término mais seguro de grupos de processos para red-teaming estável em larga escala.
