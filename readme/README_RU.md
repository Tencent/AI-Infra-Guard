...
- **2026-03-10** · [v4.0](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.0) — Запущены EdgeOne ClawScan (сканирование безопасности OpenClaw) и фреймворк Agent-Scan.
...
| **Сканирование&nbsp;уязвимостей&nbsp;AI-инфраструктуры** | Точно идентифицирует более 55 компонентов AI-фреймворков. Покрывает более 1000 известных CVE-уязвимостей. Поддерживаемые фреймворки: Ollama, ComfyUI, vLLM, n8n, Triton Inference Server и другие. |
...
Мы глубоко признательны исследовательским командам, использовавшим A.I.G в своих академических работах и внёсшим вклад в развитие исследований безопасности ИИ:
