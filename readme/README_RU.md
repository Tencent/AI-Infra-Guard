...
| **Сканирование&nbsp;уязвимостей&nbsp;AI-инфраструктуры** | Точно идентифицирует более 57 компонентов AI-фреймворков. Покрывает более 1000 известных CVE-уязвимостей. Поддерживаемые фреймворки: Ollama, ComfyUI, vLLM, n8n, Triton Inference Server и другие. |
...
4. Нажмите **Start Scan** — A.I.G идентифицирует сервис и сопоставит его с 1000+ известными CVE
