...
- **2026-08-17** · [v4.5.2](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.2) — Skill-scan: блокировка контрабанды charset и включение скомпилированного байткода (.pyc) в область аудита; MCP-scan: предотвращение RCE через инъекцию промптов; новые отпечатки векторных БД (Qdrant, Chroma, Weaviate); рефакторинг мутационного движка agent-redteam v5.0
