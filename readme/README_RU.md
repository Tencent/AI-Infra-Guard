...
- **2026-06-18** · [v4.1.14](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.1.14) — Новый skill `aig-agent-redteam` для комплексной оценки безопасности AI-агентов (red team); в Prompt Security добавлено 9 новых одноходовых jailbreak-атак.
