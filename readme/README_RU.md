...
- **2026-09-24** · [v4.6.3](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.6.3) — API Checker: поддержка сигнатур моделей Claude 5 и более надёжная идентификация моделей (неудачные образцы отпечатков автоматически дозаполняются); Prompt-Eval: бэкофф с учётом ограничений частоты, предохранитель (circuit breaker) и более безопасное завершение группы процессов для стабильного крупномасштабного ред-тиминга.
- **2026-09-17** · [v4.6.2](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.6.2) — Библиотека уязвимостей расширена на 155 новых правил CVE для более чем 40 AI-компонентов (LangFlow, n8n, PraisonAI, vLLM, llama-cpp, MLflow и др.); улучшения точности Skill-Scan (меньше ложных срабатываний без доказательств, потоковые ответы без зависаний); новые бенчмарки потери контроля агентов (FORGE-Bench, RogueHandoff-20).
