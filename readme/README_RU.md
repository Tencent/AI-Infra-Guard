...
| **Сканирование&nbsp;уязвимостей&nbsp;AI-инфраструктуры** | Точно идентифицирует более 58 компонентов AI-фреймворков. Покрывает более 1200 известных CVE-уязвимостей. Поддерживаемые фреймворки: Ollama, ComfyUI, vLLM, n8n, Triton Inference Server и другие. |
...
4. Нажмите **Start Scan** — A.I.G идентифицирует сервис и сопоставит его с 1200+ известными CVE
