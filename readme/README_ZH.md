...
- **2026-08-17** · [v4.5.2](https://github.com/Tencent/AI-Infra-Guard/releases/tag/v4.5.2) — Skill-scan：拦截字符集走私攻击、将编译字节码(.pyc)纳入审计范围；MCP-scan：防止通过 Prompt 注入触发 RCE；新增向量数据库指纹（Qdrant/Chroma/Weaviate）；agent-redteam v5.0 变异引擎重构
